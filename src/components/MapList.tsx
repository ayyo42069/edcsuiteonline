...
export const MapList: React.FC = () => {
  ...
  if (symbols.length === 0) {
    return (
        <div className="h-full w-80 flex flex-col items-center justify-center text-zinc-500 p-6 border-r border-zinc-800 bg-zinc-900">
  ...
  return (
    <div className="h-full w-80 flex-shrink-0 flex flex-col border-r border-zinc-800 bg-zinc-950 text-zinc-300 select-none">
      {/* Header */}
